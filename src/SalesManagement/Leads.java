...
public class Leads extends javax.swing.JFrame {
    ...
    public void leadList()
    {
        ...
        try {
            ...
            DefaultTableModel d = (DefaultTableModel)leadListTable.getModel();
            d.setRowCount(0);
    ...
    private void initComponents() {
        ...
        leadListTable.setForeground(new java.awt.Color(102, 102, 102));
    ...
    private void convertedButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_convertedButtonActionPerformed
        ...
        try {
            ...
            pst2 = con.prepareStatement("DELETE FROM lead_table WHERE id = ?");
            pst2.setInt(1, id);
